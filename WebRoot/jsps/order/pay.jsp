...
<div class="divContent">
	<span class="spanPrice">支付金额：</span><span class="price_t">&yen;${paydingdan.total}</span>
	<span class="spanOid">编号：${paydingdan.oid}</span>
</div>
...
<div class="divBank">
	...
	<div style="margin: 40px;">
		<a href="/goods/pay/${paydingdan.oid}" class="linkNext">下一步</a>
	</div>
</div>
</form>
  </body>
