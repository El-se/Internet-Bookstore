...
<div id="divMain">
  ...
  <div id="divBody">
  <form action="/goods/regist" method="post">
    <table id="tableForm">
      <tr>
      ...
      <tr>
        <td></td>
        <td>
          <div id="divVerifyCode"><img id="imgVerifyCode" src="<c:url value='/getverify'/>"/></div>
        </td>
        <td>
      ...
      <tr>
        ...
        <td>
          ...
          $("#submitBtn").click(function(){
          	 var flag = false
          	 flag = yanzhengloginname()&&yanzhengloginpass()&&yanzhengreloginpass()&&yanzhengemail()&&yanzhengverifyCode()
          	if(!flag){
          		alert("请正确填写个人信息")
          		return false;
          	}
